...
room generations must follow `tools/pixellab_tutorial_room_spec.json`: visible
bounds on the native 16px grid and strict orthographic high top-down output.
