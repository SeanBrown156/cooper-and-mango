...
description: Generate a consistent provisional pixel-art portrait expression sheet from character references, using a master sheet as the preferred consistency source.
---

# CM OpenAI Portrait Sprite Sheet

Use this for portrait-only generation or for extracting/refining the portrait
...
4. Preserve all defining markings and props. Require hard-edged square pixel
   ...
   gradients, text, labels, or decorative board layout.
